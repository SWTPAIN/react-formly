...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestField = __webpack_require__(212).text;
	var Formly = __webpack_require__(215);
	var FormlyConfig = __webpack_require__(216);
	...
	describe('Formly', function FormlySpec() {
	  ...
	  beforeEach(function() {
	    ...
	    var App = React.createClass({displayName: "App",
	      ...
	      render: function() {
	        return React.createElement(Formly, {config: config, model: this.state.model, onFormlyUpdate: this.onFormlyUpdate});
	      }
	    });

	    app = TestUtils.renderIntoDocument(React.createElement(App, null));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentWithPureRenderMixin = __webpack_require__(198);
	var ReactCSSTransitionGroup = __webpack_require__(200);
	var ReactFragment = __webpack_require__(206);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Danger = __webpack_require__(50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createNodesFromMarkup = __webpack_require__(52);
	var emptyFunction = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFromMixed = __webpack_require__(53);
	var getMarkupWrap = __webpack_require__(56);
	var invariant = __webpack_require__(55);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FieldMixin = __webpack_require__(214);
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("label", {ref: "label"}, 
	        React.createElement("input", {type: "text", ref: "input", name: key, value: value, onChange: this.onChange})
	      )
	    );
	  }
	});
	    ...
	    return (
	      React.createElement("div", null, 
	        React.createElement("label", null, 
	          config.label, 
	          React.createElement("input", {type: "number", ref: "input", name: key, value: value, onChange: this.onChange})
	        )
	      )
	      );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(38);
	var TestUtils = React.addons.TestUtils;
	var TestFields = __webpack_require__(212);
	...
	describe('FieldMixin', function FieldMixinSpec() {
	  describe('on its own', function() {
	    ...
	    beforeEach(function() {
	      ...
	      field = TestUtils.renderIntoDocument(React.createElement(TextField, {onValueUpdate: onValueUpdate, config: config}));
	  ...
	  describe('with Formly', function() {
	    ...
	    beforeEach(function() {
	      ...
	      var form = TestUtils.renderIntoDocument(React.createElement(App, null));
	  ...
	  describe('special cases', function() {
	    ...
	    beforeEach(function() {
	      ...
	      field = TestUtils.renderIntoDocument(React.createElement(NumberField, {onValueUpdate: noop, config: config}));
	      input = field.refs.input.getDOMNode();
	    });
